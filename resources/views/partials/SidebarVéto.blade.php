...
<div class="sidebar" id="sidebar">
      <div class="menu-list">
        <ul class="ul1">
          <li><a href="{{ route('') }}"><i class="fas fa-home"></i> Accueil</a></li>
          <li><a href="{{ route('publiveto') }}"><i class="fas fa-newspaper"></i> Publication</a></li>
          <li>
            <a href="{{ route('PagesVéto.MonProfil') }}">
                <i class="fas fa-paw"></i> Véto profil <span class="caret"></span>
            </a>
            <!-- Dropdown menu pour Pet Profil -->
            <ul class="submenu">
               
                <li><a href="{{ route('pet.PetProfil') }}">Liste des RDVs</a></li>
            </ul>
        </li>
